...
const Dock = ({windowState, setWindowState}) => {
  return (
    <footer className='dock'>
        ...
        <div onClick={()=> (window.open("https://www.linkedin.com/in/srvshah", "_blank"))} className="icon link"><img src="/doc-icons/link.svg" alt="" /></div>

        <div onClick={()=> {window.open("mailto:srv@gmail.com", "_blank")}} className="icon mail"><img src="/doc-icons/mail.svg" alt="" /></div>
